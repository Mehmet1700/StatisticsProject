...
if (bp_lm_test$p.value < 0.05) {
  cat("**Interpretation:** The Breusch-Pagan LM test is significant (p =", format(bp_lm_test$p.value, scientific = TRUE, digits = 3), 
      ").\n", "There is evidence of significant individual effects; Pooled OLS is inappropriate.")
} else {
  cat("**Interpretation:** The Breusch-Pagan LM test is not significant (p =", round(bp_lm_test$p.value, 4), 
...
```{r serial-interpretation, echo=FALSE}
if (bg_test$p.value < 0.05) {
  cat("**Interpretation:** The Breusch-Godfrey test is significant (p =", round(bg_test$p.value, 4), 
      ").\n", "There is evidence of first-order serial correlation.\n",
      "**Newey-West or cluster-robust standard errors are recommended.**")
} else {
  cat("**Interpretation:** The Breusch-Godfrey test is not significant (p =", round(bg_test$p.value, 4), 
